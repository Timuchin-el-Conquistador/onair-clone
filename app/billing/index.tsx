          ...
          <div className="grid grid-cols-3 gap-4 max-w-4xl mt-12">
            ...
            {/*<div className="col-span-2 px-4 leading-8">
              {props.subscriptionStatus == "trialing" ? (
                ...
                "Your trial ended. If you found value in using Shoporia, please consider subscribing. Sign up to a paid plan and get full access by clicking on 'Subscribe' below."
