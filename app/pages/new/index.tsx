...
import { type Integration as IIntegration } from "@/lib/types/links";
...
function NewLink(props:PageProps) {
    const { form, removeIntegration, handleSlugChange,changeAvailability } = useLinkForm(    {
        _id: "11",
        slug:'',
          ...
          <div className="flex flex-col max-w-3xl w-full">
            ...
            <div className="lg:flex w-full">
              ...
              <div className="lg:w-1/2">
                ...
                {!props.integrations.length ? <div className="lg:w-full">
                  {" "}
                  <div
                    role="alert"
