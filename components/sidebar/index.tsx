  ...
  return (
    <>
      ...
      <div id="mobile_toolbar" className="md:hidden">
        <div className="fixed z-50 grid grid-cols-4 mx-auto w-full h-16 bg-white border-t border-gray-200 bottom-0">
          <Link
            href="/dashboard"
          ...
          <button className="flex flex-col items-center justify-center w-full h-full" onClick={() =>{
        ...
        >
          ...
          <div className="flex items-center space-x-2 pb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">timuchin121@gmail.com</p>
            </div>
          </div>{" "}
          <nav>
